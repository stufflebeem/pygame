...
to lead them into battle. Press ESCAPE to pauseJust give them a push. Best of luck! Restart manually. Exit the window and run game script.

![screenshot](docs/title.png)
![screenshot](docs/directions.png)
![screenshot](docs/game.png)s
